...
# Show is a middle table of many-to-many relationship. Venue is Parent. Artist is Child
...
def search_venues():
  ...
  return render_template('pages/search_venues.html', results=response, search_term=request.FlaskForm.get('search_term', ''))
